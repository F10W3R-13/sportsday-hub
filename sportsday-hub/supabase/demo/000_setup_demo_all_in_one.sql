...
INSERT INTO public.milestones (id, date, title, team_id, category, completed, depends_on, sort_order) VALUES ('4a9e7f46-b13c-440f-afb8-285283338898', '2026-09-20'::date, 'Sports Day', NULL, 'meeting', false, NULL, 6);
...
INSERT INTO public.milestones (id, date, title, team_id, category, completed, depends_on, sort_order) VALUES ('6c0a214f-9e96-48d0-8f07-6c969bb19ca8', '2026-09-20'::date, 'Sports Day', 'management', 'event', false, NULL, 28);
...
update public.checklist_items set milestone_id = '6c0a214f-9e96-48d0-8f07-6c969bb19ca8'  -- 9/20 Sports Day
  where id in (
...
-- ═══════════ 0020_bot_runs.sql — 2026-09-18 카카오톡 시스템 폐지로 스킵(0022에서 drop) ═══════════
