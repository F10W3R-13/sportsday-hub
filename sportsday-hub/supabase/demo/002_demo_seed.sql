...
insert into public.milestones (date, title, team_id, category, completed, sort_order) values
  ...
  ('2026-08-04', '예시 예산 구조 확정',             'demo-planning',  'deliverable', true,  2),
  ('2026-08-11', '게임 규칙집 초안',                'demo-content',   'deliverable', true,  3),
  ('2026-08-18', '진행 스크립트 v1',                'demo-content',   'deliverable', true,  4),
  ('2026-08-25', '물품 견적 요청 발송',             'demo-logistics', 'deliverable', true,  5),
  ('2026-09-01', '안전 대응 매뉴얼 초안',           'demo-safety',    'deliverable', false, 6),
  ('2026-09-01', '홍보 포스터 시안 1차',            'demo-record',    'deliverable', false, 7),
  ('2026-09-08', '주간 기획 회의 (#5)',             'demo-planning',  'meeting',     false, 8),
  ('2026-09-10', '설치 리허설',                     'demo-logistics', 'event',       false, 9),
  ('2026-09-14', '최종 점검 회의',                  'demo-planning',  'meeting',     false, 10),
  ('2026-09-19', '행사 당일 (가상)',                'demo-planning',  'event',       false, 11);

-- ===== 이슈 (가상) =====
insert into public.issues (team_id, date, title, status, notes) values
  ('demo-content',   '2026-08-22', '게임 5종 확정 지연 — 팀 의견 수렴 필요', 'in_progress', '차주 회의에서 결정 (예시)'),
  ('demo-logistics', '2026-08-26', '일부 물품 리드타임 길어짐',             'open',        null),
  ('demo-safety',    '2026-08-19', '응급 연락망 양식 초안 공유 완료',       'resolved',    null);
